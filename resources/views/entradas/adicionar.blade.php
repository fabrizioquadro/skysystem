...
<div class="breadcrumb">
    <h1 class="mr-2">Adicionar Entrada</h1>
</div>
<div class="separator-breadcrumb border-top"></div>
<div class="card">
    <div class="card-body">
        <form action="{{ route('entradas.insert') }}" method="post">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="nm_fornecedor" class="form-control">
                        </div>
                        <div class="col-md-3 form-group">
                            <label for="">Nota Fiscal:</label>
                            <input type="text" name="nr_notafiscal" class="form-control">
                        </div>
                        <div class="col-md-3 form-group">
                            <label for="">Data Entrada:</label>
                            <input type="date" required name="dt_entrada" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
